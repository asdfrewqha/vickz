...
from app.database.models import Comment, CommentLike, User, Video
...
async def get_comments(
    ...
    root_comments = await adapter.get_by_values(
        Comment, {"video_id": video_id, "parent_id": None}, session=session
    )
